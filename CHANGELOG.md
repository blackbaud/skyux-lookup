...
- Fixed the lookup component to validate correctly when a value is required within a template-driven form. [#64](https://github.com/blackbaud/skyux-lookup/pull/64)
