...
- Fixed the country field component to not take up extra space below the component. [#59](https://github.com/blackbaud/skyux-lookup/pull/59)
- Fixed the country field component to properly recognize if it is within a phone field component. [#59](https://github.com/blackbaud/skyux-lookup/pull/59)
