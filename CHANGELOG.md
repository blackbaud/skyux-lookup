...
- Fixed autocomplete and lookup components to no longer throw error when users click on a browser's autofill menu. [#122](https://github.com/blackbaud/skyux-lookup/pull/122)
